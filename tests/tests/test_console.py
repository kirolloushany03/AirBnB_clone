...
and id by adding or updating attribute"
    ...
    #     with patch("sys.stdout", new=StringIO()) as output:
    #         self.assertFalse(HBNBCommand().default("create MyModel"))
    #         self.assertEqual(correct, output.getvalue().strip())
    ...
    #     correct = "** no instance found **"
    #     # with patch("sys.stdout", new=StringIO()) as output:
    #     #     self.assertFalse(HBNBCommand().default("BaseModel.update(1)"))
    #         # self.assertEqual(correct, output.getvalue().strip())
    #     with patch("sys.stdout", new=StringIO()) as output:
    ...
    #     """ Ashraf Atef """
    #     with patch("sys.stdout", new=StringIO()) as output:
    #         HBNBCommand().default("create BaseModel")
    #         testId = output.getvalue().strip()
    #     testCmd = "BaseModel.update({}, ".format(testId)
    #     testCmd += "{'attr_name': 'attr_value'})"
    #     HBNBCommand().default(testCmd)
    #     test_dict = storage.all()["BaseModel.{}".format(testId)].__dict__
    #     self.assertEqual("attr_value", test_dict["attr_name"])

        # with patch("sys.stdout", new=StringIO()) as output:
        #     HBNBCommand().default("create User")
        #     testId = output.getvalue().strip()
        # testCmd = "User.update({}, ".format(testId)
        # testCmd += "{'attr_name': 'attr_value'})"
        # HBNBCommand().default(testCmd)
        ...
        # with patch("sys.stdout", new=StringIO()) as output:
        #     HBNBCommand().default("create State")
        #     testId = output.getvalue().strip()
        # testCmd = "State.update({}, ".format(testId)
        # testCmd += "{'attr_name': 'attr_value'})"
        # HBNBCommand().default(testCmd)
        ...
        # with patch("sys.stdout", new=StringIO()) as output:
        #     HBNBCommand().default("create City")
        #     testId = output.getvalue().strip()
        # testCmd = "City.update({}, ".format(testId)
        # testCmd += "{'attr_name': 'attr_value'})"
        # HBNBCommand().default(testCmd)
    ...
    #     """ Ashraf Atef """
    #     with patch("sys.stdout", new=StringIO()) as output:
    #         HBNBCommand().default("create Place")
    #         testId = output.getvalue().strip()
    #     testCmd = "Place.update({}, ".format(testId)
